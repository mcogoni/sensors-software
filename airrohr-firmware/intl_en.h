...
const char INTL_ADS_WS1_Wspeed[] PROGMEM = "ADS-WS1 wind speed sensor";
const char INTL_ADS_WS1_Wdir[] PROGMEM = "ADS-WS1 wind direction sensor";
const char INTL_ADS_WS1_RainGauge[] PROGMEM = "ADS-WS1 rain gauge sensor";
const char INTL_DAVIS_Wspeed[] PROGMEM = "Davis wind speed sensor";
const char INTL_DAVIS_Wdir[] PROGMEM = "Davis wind direction sensor";
const char INTL_RG_11_RainGauge[] PROGMEM = "RG-11 rain gauge sensor";
...
const char INTL_WINDSPEED[] PROGMEM = "wind speed";
const char INTL_WINDDIR[] PROGMEM = "wind direction";
const char INTL_RAIN[] PROGMEM = "rain";
