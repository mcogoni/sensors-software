...
const char INTL_ADS_WS1_Wspeed[] PROGMEM = "ADS-WS1 sensore velocità vento";
const char INTL_ADS_WS1_Wdir[] PROGMEM = "ADS-WS1 sensore direzione vento";
const char INTL_ADS_WS1_RainGauge[] PROGMEM = "ADS-WS1 pluviometro";
const char INTL_DAVIS_Wspeed[] PROGMEM = "Davis sensore velocità vento";
const char INTL_DAVIS_Wdir[] PROGMEM = "Davis wind sensore direzione vento";
const char INTL_RG_11_RainGauge[] PROGMEM = "RG-11 pluviometro";
...
const char INTL_WINDSPEED[] PROGMEM = "vel.vento";
const char INTL_WINDDIR[] PROGMEM = "direzione vento";
const char INTL_RAIN[] PROGMEM = "pioggia";
